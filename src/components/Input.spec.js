...
describe('Layout', () => {
  ...
  it('has onChange callback when it is provided as prop', () => {
    ...
    // En realidad no hay propiedad onChange en html.
    // Lo que se hace es simular un evento change para nuestro item input y verificamos si nuestra función onChange se llama o no.
    const input = container.querySelector('input');
